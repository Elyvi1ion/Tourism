...
class search extends dbConnect
{
    ...
    {   
        $this->matchedTour = $result = $this->mysqli->query("SELECT * FROM `tours` WHERE `people` LIKE '%".$this->people."%' AND `difficulty` LIKE '%".$this->difficulty."%' AND `date` LIKE '%".$this->date."%' AND `region` LIKE '%".$this->region."%'  ");
    }
    //Вывод туров
            ...
            <div class="results__inner">
                ...
                <p class="results__card-tourprice">' . $output['tourprice'] . ' ₽</p>  
				  ...
				  <div class="resultsFR">
                   ...
                   <form method="get"  action="../bron.php">
