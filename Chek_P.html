...
<head>
	...
	<link rel="stylesheet" href="css/chek_p.css">
...
<body>
  ...
  <div id="popup">
     ...
     <div class="close" ><a href="#"onclick="togglePopup()">X</a></div>
       <form action="vendor/.php" method="post" enctype="multipart/from-data">
      <h2 class="text-center">
        Мы приняли ваш заказ!<br> Ожидайте <br> подтверждения<br> по e-mail
      </h2>
